...
Library    libs/db.py   #vai importar meu programa em python de exclusão, vai ficar em memória
...
# deixar disponível para esse step. Pq o Json está dentro da opção do qndo e não do então. Meio q uma variável global.
...
# Então devo ver a mensagem de alerta produto não informado     
#     [Arguments]       ${expect_message}
